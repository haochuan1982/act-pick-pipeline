...
async def main_async():    
    ...
    try:
        ...
        CAMERA_CONFIGS = [
            {
                'name' : "top",
                'driver': "usb_camera",
                'fingerprint': "/dev/video4",
                'hardwarename': "Realsense camera",
        ...
        while True:
            ...
            if result_queue.qsize() < ACTION_QUEUE_THRESHOLD and not inference_busy[0]:
            ...
            step_count += 1
            if debug and step_count % 20 == 0:  # Print every 1 second
